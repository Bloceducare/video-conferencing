  ...
  window.SelectFilter = {
    init: function (field_id, field_name, is_stacked) {
      ...
      quickElement(
        ...
        'title',
        interpolate(gettext('Type into this box to filter down the list of available %s.'), [
          field_name,
        ])
      );
      ...
      quickElement(
        ...
        'help-tooltip search-label-icon',
        'title',
        interpolate(gettext('Type into this box to filter down the list of selected %s.'), [
          field_name,
        ])
      );
