      ...
      1: [
        function (require, module, exports) {
          ...
          function _unsupportedIterableToArray(o, minLen) {
            ...
            var n = _sliceInstanceProperty((_context4 = Object.prototype.toString.call(o))).call(
              _context4,
              8,
              -1
            );
      ...
      4: [
        function (require, module, exports) {
          ...
          function _unsupportedIterableToArray(o, minLen) {
            ...
            if (!o) return;
            if (typeof o === 'string') return _arrayLikeToArray(o, minLen);
            var n = _sliceInstanceProperty2((_context9 = Object.prototype.toString.call(o))).call(
              _context9,
              8,
              -1
            );
          ...
          XRegExp.cache = function (pattern, flags) {
            ...
            return (
              regexCache[pattern][flags] || (regexCache[pattern][flags] = XRegExp(pattern, flags))
            );
                ...
                (0, _slice['default'])((_context3 = String(str)))
                  ...
                  .replace(r2, function () {
                    ...
                    for (var i = 1; i < len - 2; ++i) {
                      if (
                        (i < 0 || arguments.length <= i ? undefined : arguments[i]) === undefined
                      ) {
                        match[i] = undefined;
                      }
                    }
          ...
          $(
            { target: 'Array', proto: true, forced: FORCED },
            {
              sort: function sort(comparefn) {
                ...
                if (STABLE_SORT)
                  return comparefn === undefined ? un$Sort(array) : un$Sort(array, comparefn);
