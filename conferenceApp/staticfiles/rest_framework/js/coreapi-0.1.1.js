          ...
          var ParameterError = (function (_Error) {
            ...
            function ParameterError(message) {
              ...
              var _this = _possibleConstructorReturn(
                this,
                (ParameterError.__proto__ || Object.getPrototypeOf(ParameterError)).call(
                  this,
                  message
                )
              );
          ...
          var LinkLookupError = (function (_Error2) {
            ...
            function LinkLookupError(message) {
              ...
              var _this2 = _possibleConstructorReturn(
                this,
                (LinkLookupError.__proto__ || Object.getPrototypeOf(LinkLookupError)).call(
                  this,
                  message
                )
              );
          ...
          var ErrorMessage = (function (_Error3) {
            ...
            function ErrorMessage(message, content) {
              ...
              var _this3 = _possibleConstructorReturn(
                this,
                (ErrorMessage.__proto__ || Object.getPrototypeOf(ErrorMessage)).call(this, message)
              );
              ...
              },
              {
                ...
                value: function action(link, decoders) {
                  ...
                  return this.fetch(request.url, request.options).then(function (response) {
                    ...
                    return parseResponse(response, decoders, responseCallback).then(function (
                      data
                    ) {
                      if (response.ok) {
                        return data;
            ...
            UrlTemplate.prototype.getValues = function (context, operator, key, modifier) {
              ...
              if (this.isDefined(value) && value !== '') {
                if (
                  ...
                  result.push(
                    this.encodeValue(operator, value, this.isKeyOperator(operator) ? key : null)
                  );
                } else {
                  if (modifier === '*') {
