  ...
  return {
    ...
    c: [
      ...
      },
      {
        ...
        c: [r, i, e.QSM, e.ASM, o, e.CSSNM, { cN: 'preprocessor', b: '\\s[A-Za-z0-9_.-]+', r: 0 }],
      },
    ],
  };
});
...
hljs.registerLanguage('vbscript-html', function (s) {
  return { sL: 'xml', subLanguageMode: 'continuous', c: [{ b: '<%', e: '%>', sL: 'vbscript' }] };
});
...
hljs.registerLanguage('profile', function (e) {
  return {
    c: [
      ...
      { cN: 'filename', b: '[a-zA-Z_][\\da-zA-Z_]+\\.[\\da-zA-Z_]{1,3}', e: ':', eE: !0 },
      {
        cN: 'header',
...
hljs.registerLanguage('xl', function (e) {
  var t =
    ...
    n = { cN: 'string', b: "'", e: "'", i: '\\n' },
    s = { cN: 'string', b: '<<', e: '>>' },
    c = { cN: 'number', b: '[0-9]+#[0-9A-Z_]+(\\.[0-9-A-Z_]+)?#?([Ee][+-]?[0-9]+)?', r: 10 },
    _ = { cN: 'import', bK: 'import', e: '$', k: { keyword: 'import', module: t }, r: 0, c: [l] },
    d = { cN: 'function', b: '[a-z].*->' };
  return {
    aliases: ['tao'],
    l: /[a-zA-Z][a-zA-Z0-9_?]*/,
...
hljs.registerLanguage('smali', function (r) {
  ...
  return {
    ...
    c: [
      ...
      { cN: 'instruction', b: '\\s(' + t.join('|') + ')((\\-|/)[a-zA-Z0-9]+)+\\s', r: 10 },
      { cN: 'instruction', b: '\\s(' + n.join('|') + ')((\\-|/)[a-zA-Z0-9]+)*\\s', r: 10 },
      { cN: 'class', b: 'L[^(;:\n]*;', r: 0 },
      { cN: 'function', b: '( |->)[^(\n ;"]*\\(', r: 0 },
      { cN: 'function', b: '\\)', r: 0 },
...
hljs.registerLanguage('powershell', function (e) {
  var t = { b: '`[\\s\\S]', r: 0 },
    ...
    o = { cN: 'string', b: /"/, e: /"/, c: [t, r, { cN: 'variable', b: /\$[A-z]/, e: /[^A-z]/ }] },
    a = { cN: 'string', b: /'/, e: /'/ };
  return {
    aliases: ['ps'],
    l: /-?[A-z\.\-]+/,
...
hljs.registerLanguage('scheme', function (e) {
  ...
  return (d.c = [c, l, s, u, p, g].concat(o)), { i: /\S/, c: [n, l, s, p, g].concat(o) };
});
...
hljs.registerLanguage('gcode', function (e) {
  ...
  return { aliases: ['nc'], cI: !0, l: N, k: c, c: [{ cN: 'preprocessor', b: i }, r].concat(l) };
});
...
hljs.registerLanguage('vbnet', function (e) {
  return {
    ...
    c: [
      ...
      e.CNM,
      { cN: 'preprocessor', b: '#', e: '$', k: 'if else elseif end region externalsource' },
    ],
  };
});
hljs.registerLanguage('q', function (e) {
  ...
  return { aliases: ['k', 'kdb'], k: s, l: /\b(`?)[A-Za-z0-9_]+\b/, c: [e.CLCM, e.QSM, e.CNM] };
});
...
hljs.registerLanguage('nimrod', function (t) {
  return {
    ...
    c: [
      ...
      { cN: 'number', b: /\b(0[xX][0-9a-fA-F][_0-9a-fA-F]*)('?[iIuU](8|16|32|64))?/, r: 0 },
...
hljs.registerLanguage('ruby', function (e) {
  var c = '[a-zA-Z_]\\w*[!?=]?|[-+~]\\@|<<|>>|=~|===?|<=>|[<>]=?|\\*\\*|[-/+%^&*~`|]|\\[\\]=?',
    ...
    d = [
      ...
      { cN: 'function', bK: 'def', e: ' |$|;', r: 0, c: [e.inherit(e.TM, { b: c }), i].concat(n) },
...
hljs.registerLanguage('livecodeserver', function (e) {
  ...
  return {
    ...
    c: [
      ...
      { cN: 'command', bK: 'command on', e: '$', c: [r, o, e.ASM, e.QSM, e.BNM, e.CNM, a] },
...
hljs.registerLanguage('less', function (e) {
  ...
  c.push(
    ...
    s('function', '(url|data-uri)', { starts: { cN: 'string', e: '[\\)\\n]', eE: !0 } }),
    s('function', r),
    b,
    i('variable', '@@?' + r, 10),
    i('variable', '@{' + r + '}'),
